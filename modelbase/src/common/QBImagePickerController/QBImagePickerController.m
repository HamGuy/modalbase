...
//        [self.navigationItem setLeftBarButtonItem:cancelButton animated:NO];
        [self addLeftBarButtonWithName:@"取消" withAction:@selector(cancel:)];
    } else {
...
{
    // Delegate
    if (self.delegate && [self.delegate respondsToSelector:@selector(imagePickerControllerDidCanceled:)]) {
        [self.delegate imagePickerControllerDidCanceled:self];
    }
}
