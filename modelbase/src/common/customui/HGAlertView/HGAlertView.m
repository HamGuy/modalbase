...
@property (nonatomic, copy) HGAlertViewClickedBlock clickedBlok;
...
- (void)addButtonsToView: (UIView *)container
{
    ...
    for (int i=0; i<[_buttonTitles count]; i++) {
        ...
        [closeButton addTarget:self action:@selector(touchTheButton:) forControlEvents:UIControlEventTouchUpInside];
